 ...
 */
Zotero.MASMetaData.ProgressWindow = function(options = {}) {
	var _window = options.window || null;
	var _callOnClick = typeof options.callOnClick == 'undefined' ? [function() {self.close()}] : options.callOnClick; //calls array of functions on click
	var self = this,
	...
	function changeHeadlineNow () {
		changeHeadline("testing test")
	}
